...
lazy val server = project
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "com.lightbend.akka.discovery" %% "akka-discovery-config" % "0.19.0",
      "com.lightbend.akka.discovery" %% "akka-discovery-aws-api-async" % "0.19.0",
  ...
  .settings(libraryDependencies ++= Seq(
    ...
    "com.typesafe.akka" %% "akka-stream-testkit" % "2.5.17" % IntegrationTest
  ))
  .enablePlugins(
    BuildInfoPlugin,
    JavaAppPackaging,

...
lazy val server = project
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "com.lightbend.akka.discovery" %% "akka-discovery-aws-api-async" % "0.13.0",
      "com.lightbend.akka.management" %% "akka-management-cluster-http" % "0.13.0",
      "com.lightbend.akka.management" %% "akka-management-cluster-bootstrap" % "0.13.0",

...
lazy val server = project
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "com.lightbend.akka.discovery" %% "akka-discovery" % "0.11.0",
      "com.lightbend.akka.management" %% "akka-management-cluster-http" % "0.11.0",
      "com.lightbend.akka.management" %% "akka-management-cluster-bootstrap" % "0.11.0",

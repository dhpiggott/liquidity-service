...
lazy val model = project
  ...
  .settings(libraryDependencies ++= Seq(
    ...
    "com.typesafe.akka" %% "akka-actor-typed" % "2.5.15"
  ))
...
lazy val server = project
  ...
  .settings(libraryDependencies ++= Seq(
    ...
    "com.typesafe.akka" %% "akka-cluster-typed" % "2.5.15",
    "com.typesafe.akka" %% "akka-cluster-sharding-typed" % "2.5.15",
    "com.typesafe.akka" %% "akka-cluster-tools" % "2.5.15",
    "com.typesafe.akka" %% "akka-persistence-typed" % "2.5.15",
    "com.typesafe.akka" %% "akka-persistence-query" % "2.5.15",
    "com.github.dnvriend" %% "akka-persistence-jdbc" % "3.4.0",
    "org.tpolecat" %% "doobie-core" % "0.5.2",
    "org.tpolecat" %% "doobie-hikari" % "0.5.2",
    "mysql" % "mysql-connector-java" % "5.1.47",
    "com.typesafe.akka" %% "akka-http" % "10.1.4",
    "com.typesafe.akka" %% "akka-stream-typed" % "2.5.15",
  ...
  .settings(libraryDependencies ++= Seq(
    ...
    "com.typesafe.akka" %% "akka-actor-testkit-typed" % "2.5.15" % Test,
  ...
  .settings(libraryDependencies ++= Seq(
    ...
    "com.typesafe.akka" %% "akka-stream-testkit" % "2.5.15" % IntegrationTest
  ))
  .enablePlugins(
    BuildInfoPlugin,
    JavaAppPackaging,

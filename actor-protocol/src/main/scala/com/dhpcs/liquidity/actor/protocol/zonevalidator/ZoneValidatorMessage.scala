...
import com.dhpcs.liquidity.actor.protocol.clientconnection.{SerializableClientConnectionMessage, ZoneResponseEnvelope}
...
final case class RemoveClient(clientConnection: ActorRef[SerializableClientConnectionMessage])

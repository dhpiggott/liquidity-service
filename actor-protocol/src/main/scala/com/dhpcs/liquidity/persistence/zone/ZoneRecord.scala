...
final case class ClientJoinedEvent(clientConnectionActorRef: Option[ActorRef[SerializableClientConnectionMessage]])
    extends ZoneEvent
final case class ClientQuitEvent(clientConnectionActorRef: Option[ActorRef[SerializableClientConnectionMessage]])
    extends ZoneEvent

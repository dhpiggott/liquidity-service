...
import com.dhpcs.liquidity.ws.protocol.legacy.LegacyWsProtocolSpec.LegacyModelFormatsSpec.ValueFormatSpec.TestValue
          ...
          val member = Member(
            ...
            Some(
              com.google.protobuf.struct.Struct(
                Map(
                  "color" -> com.google.protobuf.struct
                    .Value(com.google.protobuf.struct.Value.Kind.StringValue("0x0000FF"))
                )))
          )
          val memberJson = Json.parse(
            s"""

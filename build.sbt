...
lazy val server = project
  ...
  .settings(libraryDependencies ++= Seq(
    ...
    "com.typesafe.akka" %% "akka-http-testkit" % "10.1.6" % IntegrationTest,
    "com.typesafe.akka" %% "akka-stream-testkit" % "2.5.19" % IntegrationTest
  ))
  .enablePlugins(
    BuildInfoPlugin,
    JavaAppPackaging,

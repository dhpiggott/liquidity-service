...
object ProtoBindings {
  ...
  implicit final val ZoneResponseEnvelopeProtoBinding
    : ProtoBinding[ZoneResponseEnvelope, proto.actor.protocol.clientconnection.ZoneResponseEnvelope, ActorRefResolver] =
    cachedImplicit

  implicit final val GetZoneStateCommandProtoBinding
    : ProtoBinding[GetZoneStateCommand, proto.actor.protocol.zonevalidator.GetZoneStateCommand, ActorRefResolver] =
    cachedImplicit

  implicit final val ZoneCommandEnvelopeProtoBinding
    : ProtoBinding[ZoneCommandEnvelope, proto.actor.protocol.zonevalidator.ZoneCommandEnvelope, ActorRefResolver] =
    cachedImplicit

  implicit final val ZoneNotificationEnvelopeProtoBinding
    : ProtoBinding[ZoneNotificationEnvelope,
  ...
  implicit final val ZoneEventEnvelopeProtoBinding
    : ProtoBinding[ZoneEventEnvelope, proto.persistence.zone.ZoneEventEnvelope, ActorRefResolver] = cachedImplicit
